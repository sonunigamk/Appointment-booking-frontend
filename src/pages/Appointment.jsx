  ...
  return docInfo && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        <div>
          <img className='bg-primary w-full sm:max-w-72 rounder-lg' src={docInfo.image} alt="" />
        </div>
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>

          {/* doctors info : name degree experience */}

          <p className='flex items-center gap-2 text-2xl font-medium text-green-900'>
            {docInfo.name}
            <img className='w-5' src={assets.verified_icon} alt="blue tick" />
          </p>

...
const navigate = useNavigate()
    ...
    return (
        <div className='main-container flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10  '>
            {/* leftside */}
            <div className="left-box flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
            ...
            <div className="right-box hidden md:block md:w-1/2 lg:w-[370px] relative">
